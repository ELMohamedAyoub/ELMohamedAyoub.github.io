...
import { ProfileType, profileContent } from "@/lib/profile-content";
...
const Hero = ({ currentProfile }: HeroProps) => {
  const [displayedText, setDisplayedText] = useState("");
  const [currentIndex, setCurrentIndex] = useState(0);
  const content = profileContent[currentProfile].hero;
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="text-primary text-lg font-medium mb-4 block">Hi there!</span>
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              I'm <span className="gradient-text">ELMOUSATI Mohamed Ayoub</span>
            </h1>
          </motion.div>
          ...
          >
            <p className="text-xl md:text-2xl text-foreground/90">{content.tagline}</p>
            <p className="text-lg md:text-xl text-muted-foreground">{taglineText}</p>
          </motion.div>
  ...
  <Button
    ...
    asChild
  >
    <a href="https://www.linkedin.com/in/elmohamedayoub" target="_blank" rel="noopener noreferrer" className="flex items-center">
...
<MagneticButton strength={0.4}>
  <Button
    ...
    asChild
  >
    <a href="https://github.com/ELMohamedAyoub" target="_blank" rel="noopener noreferrer" className="flex items-center">
...
<MagneticButton strength={0.4}>
  <Button
    size="lg"
    variant="outline"
    className="border-sky-500 text-sky-500 hover:bg-sky-500 hover:text-white dark:border-sky-400 dark:text-sky-400 dark:hover:bg-sky-400 dark:hover:text-black"
    asChild
  >
    <a
      href="https://twitter.com/ELMohamedAyoub"
      target="_blank"
...
<MagneticButton strength={0.4}>
  <Button
    ...
    asChild
  >
    <a href="/Mohamed_Ayoub_ELMOUSATI_CV.pdf" download="Mohamed_Ayoub_ELMOUSATI_CV.pdf" className="flex items-center">

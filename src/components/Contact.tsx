...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone",
      value: "+212 696 863 552",
      link: "tel:+212696863552",
    },
    {
      icon: Mail,
      title: "Email Address",
      value: "ayubmousati@gmail.com",
      link: "mailto:ayubmousati@gmail.com",
    },
  ];
  ...
  const socials = [
    {
      icon: Linkedin,
      label: "LinkedIn",
      link: "https://linkedin.com/in/elmohamedayoub",
    },
    {
      icon: Github,
      label: "GitHub",
      link: "https://github.com/ELMohamedAyoub",
    },
    {
      icon: FaXTwitter,
      label: "Twitter",
      link: "https://twitter.com/elmohamedayoub",
    },
  ];
